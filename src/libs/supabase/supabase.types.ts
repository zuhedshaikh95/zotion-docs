...
export type WorkspaceI = InferSelectModel<typeof workspaces>;

export type UserI = InferSelectModel<typeof users>;

export type FolderI = InferSelectModel<typeof folders>;

export type FileI = InferSelectModel<typeof files>;

export type CustomerI = InferSelectModel<typeof customers>;
