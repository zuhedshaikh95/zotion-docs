...
import { getFiles } from "@/libs/supabase/queries";

export type appFoldersType = FolderI & { files: FileI[] | [] };
export type appWorkspacesType = WorkspaceI & {
...
type Action =
  ...
  | {
      type: "ADD_FILE";
      payload: { workspaceId: string; file: FileI; folderId: string };
    }
  | {
      type: "DELETE_FILE";
  ...
  | {
      type: "SET_FILES";
      payload: { workspaceId: string; files: FileI[]; folderId: string };
    }
  | {
      type: "UPDATE_FOLDER";
      payload: {
